...
int main() {
    ...
    */
    ...
    bool bl1 = a;
    bool bl2 = c;
    cout << "Printing the values of implicit type casting" << endl;
    ...
    cout << "Printing the values of explicit type casting" << endl;
    // a] C-style type casting
    ...
    cout << "function style type casting -->" << endl;
    int I = 43;
    char Ch = 'B';
    ...
    *s_ptr2 = 43;
    ...
    // d] dynamic type casting
    cout << "dynamic type casting -->" << endl;
    //The dynamic cast can only be used with pointers and references to classes or void* i.e void pointers
    child c_obj;
    parent* parent_ptr = dynamic_cast <parent*> (&c_obj);

    if(parent_ptr){
        cout << "Upcasted from child to parent" << endl;
        parent_ptr->print();
    } else{
        cout << "Upcasting failed" << endl;
    }

    child* child_ptr = dynamic_cast <child*> (parent_ptr);
    
    if(child_ptr){
        cout << "Downcasted from parent to child" << endl;
        child_ptr->print();
        child_ptr->fun();
    } else{
    ...
    *const_ptr2 = 75;
    ...
    // f] reinterpret type casting
    cout << "reinterpret type casting -->" << endl;
    int re_var = 97;
